...
img_path = '/home/ferryliu/.Dataset/crackDetection/JPEGImage'
...
###############
C.model_path = './Models/'
model_names = os.listdir(C.model_path)
model_names.sort()
model_name = model_names[0]
C.model_path = C.model_path + model_name

model_rpn.load_weights(C.model_path, by_name=True)
print('model path: ', C.model_path)
...
for idx, img_name in enumerate(sorted(os.listdir(img_path))):
    ...
    for key in bboxes:
        ...
        for jk in range(new_boxes.shape[0]):
            ...
            img_scaled = cv2.rectangle(img_scaled, (x1, y1), (x2, y2),
                          next(colors), 3)
